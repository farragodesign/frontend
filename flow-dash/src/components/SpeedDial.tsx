...
function SpeedDila() {
  ...
  return (
      ...
      onMouseOut={()=> setIsOpen(false)} data-dial-init className="fixed right-6 bottom-6 group">
        <div
          id="speed-dial-menu-default"
          className={` ${isOpen ? 'flex flex-col' : 'hidden' } items-center  mb-4 space-y-2`}
        >
          <button
            type="button"
